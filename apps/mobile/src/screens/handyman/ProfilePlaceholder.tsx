  ...
  return (
    <SafeAreaView style={{ flex: 1, padding: 16, gap: 12 }}>
      ...
      >
        ...
        {session?.me.handyman_profile ? (
          <>
            <Text style={{ opacity: 0.7 }}>
              Experience: {session.me.handyman_profile.years_experience} years
            </Text>
            <Text style={{ opacity: 0.7 }}>
              Radius: {session.me.handyman_profile.service_radius_km} km
            </Text>
            <Text style={{ opacity: 0.7 }}>
              Skills: {session.me.handyman_profile.skills.join(", ")}
            </Text>
          </>
        ) : null}
      </View>
