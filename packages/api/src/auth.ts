...
export type OnboardingUserResponse = components["schemas"]["OnboardingUserResponse"];
export type OnboardingHandymanBody = components["schemas"]["OnboardingHandymanRequest"];
export type OnboardingHandymanResponse = components["schemas"]["OnboardingHandymanResponse"];
export type MeResponse = components["schemas"]["MeResponse"];

export async function login(api: ApiClient, body: LoginBody): Promise<TokenPairResponse> {
  return api.request<TokenPairResponse>("/login", { method: "POST", json: body, skipAuthRefresh: true });
}

export async function register(api: ApiClient, body: RegisterBody): Promise<unknown> {
  return api.request("/register", { method: "POST", json: body, skipAuthRefresh: true });
}

export async function onboardingUser(api: ApiClient, body: OnboardingUserBody): Promise<OnboardingUserResponse> {
...
export async function refresh(api: ApiClient, body: RefreshBody): Promise<TokenPairResponse> {
...
export async function logout(api: ApiClient, body: LogoutBody): Promise<{ ok?: boolean }> {
